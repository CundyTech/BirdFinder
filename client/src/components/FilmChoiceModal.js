    ...
    <Modal visible={visible} transparent animationType="fade" onRequestClose={onClose}>
      <View style={styles.filmModalBackdrop}>
        <View style={styles.filmModalCard}>
          <Text style={styles.filmModalTitle}>{t('modals.filmChoice.title')}</Text>
          <Text style={styles.filmModalSubtitle}>{t('modals.filmChoice.subtitle')}</Text>
          ...
          <TouchableOpacity style={styles.filmModalOption} onPress={onUseFilm} activeOpacity={0.85}>
            ...
            <View style={styles.filmModalOptionText}>
              <Text style={styles.filmModalOptionTitle}>{t('modals.filmChoice.useFilm')}</Text>
              <Text style={styles.filmModalOptionSub}>{t('modals.filmChoice.filmAvailable', { count: filmBalance })}</Text>
            </View>
          </TouchableOpacity>
          ...
          >
            ...
            <View style={styles.filmModalOptionText}>
              <Text style={styles.filmModalOptionTitle}>{t('modals.filmChoice.watchAdInstead')}</Text>
              <Text style={styles.filmModalOptionSub}>
                {adLoaded ? t('modals.filmChoice.adCoversId') : t('common.loadingAd')}
              </Text>
            </View>
          </TouchableOpacity>

          <TouchableOpacity style={styles.filmModalClose} onPress={onClose}>
            <Text style={styles.filmModalCloseText}>{t('common.cancel')}</Text>
          </TouchableOpacity>
        </View>
      </View>
    </Modal>
